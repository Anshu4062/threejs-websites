  ...
  "runtime/src/core/dev/use-ses-shim.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var ReactSharedInternals = import_react3.default.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
        ...
        var useState3 = import_react3.default.useState, useEffect2 = import_react3.default.useEffect, useLayoutEffect3 = import_react3.default.useLayoutEffect, useDebugValue = import_react3.default.useDebugValue;
        var didWarnOld18Alpha = false;
        var didWarnUncachedGetSnapshot = false;
        function useSyncExternalStore2(subscribe, getSnapshot, getServerSnapshot) {
          {
            if (!didWarnOld18Alpha) {
              if (import_react3.default.startTransition !== void 0) {
        ...
        var useSyncExternalStore$2 = import_react3.default.useSyncExternalStore !== void 0 ? import_react3.default.useSyncExternalStore : shim;
...
var import_react2, import_use_ses_shim, prettyBytes, withTimeout, toolbar_default;
...
// runtime/src/core/index.ts
var IS_REACT_19 = React3.version.startsWith("19");
...
var Slot = /* @__PURE__ */ React3.forwardRef(
  (props, forwardedRef) => {
...
var renderInnerProfiler = (element, id, timeQueue) => {
  ...
  return /* @__PURE__ */ React3.createElement(Slot, {
    _l: element,
    _c: void 0,
    _p: profiler
  });
...
var captureJSX = (key, element, loc, secondaryLoc, index, profilerType, noisy, cache) => {
  ...
  const outerProfiler = React3.createElement(Profiler2, {
    id: key,
    key: existingKey,
  ...
  return /* @__PURE__ */ React3.createElement(Slot, {
    key: existingKey,
    _l: element,
    _c: React3.isValidElement(children) ? renderInnerProfiler(children, key, timeQueue) : children,
    _p: outerProfiler
  });
};
...
var captureMount = (key, data, loc) => {
  ...
  return {
    n: noisy,
    c: React3.useState(() => new _Array(data.c))[0]
  };
};
